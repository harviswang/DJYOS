...
{
    u8 buf1[512]= "abcdefghijklmnopqrstuvwxyz";
    u8 buf2[512];
    u32 i;
    

    
    erase_block_nand(3000*32*512);
    __write_sector_nand_with_ecc(3000*32,0, buf1, 512);
    __read_sector_nand_with_ecc(3000*32, 0,buf2, 512);
        for(i=0;i<15;i++)
    {
      if(buf1[i]==buf2[i] )
        {
