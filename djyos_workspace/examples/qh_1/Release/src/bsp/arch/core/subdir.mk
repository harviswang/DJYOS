...
src/bsp/arch/core/cpus.o: D:/djysdk/djysrc/djyos/bsp/arch/arm/cortex_m/cortex_m3/core/cpus.S
	...
	arm-none-eabi-gcc -x assembler-with-cpp -Drelease -I"D:/djysdk/djysrc/examples/qh_1/src/bsp/arch/cpu/include" -Wall -Wa,-adhlns="$@.lst" -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -mcpu=cortex-m3 -mthumb -g3 -gdwarf-2 -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
